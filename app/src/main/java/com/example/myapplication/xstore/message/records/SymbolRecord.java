...
import com.example.myapplication.xstore.message.codes.MARGIN_MODE;
import com.example.myapplication.xstore.message.codes.PROFIT_MODE;
import com.example.myapplication.xstore.message.codes.SWAP_ROLLOVER_TYPE;
import com.example.myapplication.xstore.message.codes.SWAP_TYPE;
