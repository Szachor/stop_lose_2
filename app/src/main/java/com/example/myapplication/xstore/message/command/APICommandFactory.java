...
import com.example.myapplication.xstore.message.codes.PERIOD_CODE;
import com.example.myapplication.xstore.message.codes.TRADE_OPERATION_CODE;
import com.example.myapplication.xstore.message.codes.TRADE_TRANSACTION_TYPE;
import com.example.myapplication.xstore.message.error.APICommandConstructionException;
import com.example.myapplication.xstore.message.error.APICommunicationException;
import com.example.myapplication.xstore.message.error.APIReplyParseException;
import com.example.myapplication.xstore.message.records.ChartLastInfoRecord;
import com.example.myapplication.xstore.message.records.ChartRangeInfoRecord;
import com.example.myapplication.xstore.message.records.RedirectRecord;
import com.example.myapplication.xstore.message.records.TradeTransInfoRecord;
import com.example.myapplication.xstore.message.response.APIErrorResponse;
import com.example.myapplication.xstore.message.response.AllSymbolsResponse;
import com.example.myapplication.xstore.message.response.CalendarResponse;
import com.example.myapplication.xstore.message.response.ChartResponse;
import com.example.myapplication.xstore.message.response.CommissionDefResponse;
import com.example.myapplication.xstore.message.response.CurrentUserDataResponse;
import com.example.myapplication.xstore.message.response.IbsHistoryResponse;
import com.example.myapplication.xstore.message.response.LoginResponse;
import com.example.myapplication.xstore.message.response.LogoutResponse;
import com.example.myapplication.xstore.message.response.MarginLevelResponse;
import com.example.myapplication.xstore.message.response.MarginTradeResponse;
import com.example.myapplication.xstore.message.response.NewsResponse;
import com.example.myapplication.xstore.message.response.PingResponse;
import com.example.myapplication.xstore.message.response.ProfitCalculationResponse;
import com.example.myapplication.xstore.message.response.ServerTimeResponse;
import com.example.myapplication.xstore.message.response.StepRulesResponse;
import com.example.myapplication.xstore.message.response.SymbolResponse;
import com.example.myapplication.xstore.message.response.TickPricesResponse;
import com.example.myapplication.xstore.message.response.TradeRecordsResponse;
import com.example.myapplication.xstore.message.response.TradeTransactionResponse;
import com.example.myapplication.xstore.message.response.TradeTransactionStatusResponse;
import com.example.myapplication.xstore.message.response.TradesHistoryResponse;
import com.example.myapplication.xstore.message.response.TradesResponse;
import com.example.myapplication.xstore.message.response.TradingHoursResponse;
import com.example.myapplication.xstore.message.response.VersionResponse;
import com.example.myapplication.xstore.sync.Credentials;
import com.example.myapplication.xstore.sync.Server;
import com.example.myapplication.xstore.sync.SyncAPIConnector;
